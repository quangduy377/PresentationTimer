...
public class MainActivity extends Activity implements TimerLogic.TimerCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //The stop/start button, reset button
        ...
        //Setup a pref environment to get globally shared variables
        mPrefs = new Prefs(this);
        //Instantiate 3 different bells
    ...
    private void updateTimeLabel() {
        ...
        //If it is not counting down , perhaps due to a click interrupt.
        if (!mIsCountDown) {
            t = currentTime;
        }
        //
        ...
        //set the text color according to the bell time
        int col;
    ...
    //For turning on the setting page
